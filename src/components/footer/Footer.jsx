  ...
  return (
    <div className='footer'>
        ...
        <div className="socialContainer">
          <a href="https://www.linkedin.com/in/shashi-bhushan-kumar-35b6401a8" className='iconSocial' target='_blank' rel="noreferrer"><img src={linkedIn} alt="" /></a>
          <a href="https://github.com/Bhushan727" className='iconSocial' target='_blank' rel="noreferrer"><img src={github} alt="" /></a>
        </div>
